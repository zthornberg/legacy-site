import { sellProcess } from "../content/process";

export default function ProcessSell() {
  document.title = "Sell-Side Process | Legacy";
  const p = sellProcess;
    ...
    <div className="pt-20 bg-white">
      <div className="mx-auto max-w-screen-xl px-4 md:px-6 py-10">
        ...
        <div className="mt-8">
          ...
          <a href="/contact" className="mt-3 inline-block rounded-lg bg-slate-900 text-white px-4 py-2">Talk to an Advisor</a>
        </div>
      </div>
    </div>
  );
